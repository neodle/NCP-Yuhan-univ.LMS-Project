...
전체 요구 항목과 비용 산정 기준은 [`docs/rfp-summary.ko.md`](docs/rfp-summary.ko.md)에 정리했습니다.
...
| 문서 | 내용 |
| --- | --- |
| [`docs/architecture.ko.md`](docs/architecture.ko.md) | 아키텍처 5단계 변화 과정과 각 단계의 설계 의도 |
| [`docs/rfp-summary.ko.md`](docs/rfp-summary.ko.md) | 제안요청서 요약, 요구 인프라 사양, 비용 산정 기준 |
| [`docs/journal.ko.md`](docs/journal.ko.md) | 일자별 상세 진행 일지 |
